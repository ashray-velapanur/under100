 ...
 *
 */
class Radweb_Stripe_Block_Info extends Mage_Payment_Block_Info_Cc
{
    /**
    ...
    {
        parent::_construct();
        //$this->setTemplate('radweb/stripe/payment/info/default.phtml');
        ...
        $transport = parent::_prepareSpecificInformation($transport);
            $transport->addData(array(
                Mage::helper('payment')->__('Expiration Date') => $this->_formatCardDate(
                    $info->getData('cc_exp_year'), $info->getData('cc_exp_month')
                ),
                Mage::helper('payment')->__('Credit Card Number') => '**********'.$info->getData('cc_last4'),
            ));
