<?php
class Mage_Rating_Model_Api extends Mage_Api_Model_Resource_Abstract{
	public function _construct(){
		$this->model= Mage::getModel("raiting/raiting");
	}
...
// 		if($response) return array("response"=>$this->helper->countLikes($productID)); else return array(array("error"=>"500"));
...
// 	}
    ...
    {
    	return Mage::getModel("rating/rating")->getOptions();
    	return 1; $this->info();
