...
/**
 * Class GaussDev_Notifications_Model_Type_Post_Commented
 *
 * data_id table field - gaussdev_comments.entity_id
 */
class GaussDev_Notifications_Model_Type_Post_Commented extends GaussDev_Notifications_Model_Type_Abstract
{
    public function getText()
    {
        $text = Mage::helper('core')->__('%s has commented on your post.', Mage::helper('notifications')->getName($this->getInitiator()));
