 ...
 */
class GaussDev_CustomerImages_Model_Config implements Mage_Media_Model_Image_Config_Interface
{
    ...
    /**
     * Web-based directory path of temporary profile images
    ...
    /**
     * Web-based directory path of profile images
     * relatively to media folder
     *
     * @return string
     */
    ...
    /**
     * Part of URL of temporary profile images
     * relatively to media folder
     *
     * @param $file
     *
    ...
    /**
     * Part of URL of profile images relatively to media folder
     *
     * @param $file
     *
     * @return string
    ...
    /**
     * Filesystem directory path of temporary profile images
     * relatively to media folder
     *
     * @return string
     */
