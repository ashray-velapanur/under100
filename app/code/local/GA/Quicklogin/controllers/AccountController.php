...
class GA_Quicklogin_AccountController extends Mage_Customer_AccountController
{
    ...
    public function loginAction(){
        $this->_getSession()->setData('redirected_from_login', true);
        $this->_redirect('/');
...
//    {
//        $this->_redirect(null, array('_direct' => 'profile', '_fragment' => 'settings'));
//        $this->getResponse()->sendHeadersAndExit();
//    }
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if (!empty($login['username']) && !empty($login['password'])) {
                try {
                    ...
                    $result['customerid'] = $session->getCustomer()->getId();
